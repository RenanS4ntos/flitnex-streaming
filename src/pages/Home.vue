...
onMounted(() => moviesStore.init())

// // Adicionar watch para verificar quando os dados são atualizados
// watch(
//   () => moviesStore.movies_popular,
//   (newVal) => {
//     console.log('moviesStore.movies_popular updated:', newVal)
//   }
// );

// watch(
//   () => moviesStore.movies_top_rated,
//   (newVal) => {
//     console.log('moviesStore.movies_top_rated updated:', newVal);
//   }
// );
...
//   () => movies,
//   (newVal) => {
//     console.log('movies updated:', newVal);
//   }
// );
</script>
